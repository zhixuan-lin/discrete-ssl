...
TRIAL_NAME="type=vq-lr=0.02-epochs=800-bs=512-K-256-D=64-upscale=1-tau=1.0-tau_end=800-vq_weight=1.0-beta=0.25-n_conv=2-fix_lr=False-fix_tau=False-init-res_proj-grad_norm_1"
mkdir -p $DATA_DIR
